## 👋🏻 Hey everyone, I'm Mohammad Padra Esfandiyar®™ AKA TheKidPadra®™ 👋🏻
<!--
...
I’m interested in the fields of Robotics, Numerical and Mathematical Optimization within Robotic Systems, Computer Vision as it pertains to decision-making, Image Processing, and investigative studies in machine learning, especially for generative models and probabilistic deep learning models. I work as a Software Engineer, engaged in the development of websites, iOS/iPadOS, and web applications, alongside my academic pursuits. I’m currently an MSc AI and Robotics student @ Sharif University of Technology, working on projects to enhance visual data processing to elevate the automation of Robots, casual learning, and diffusion models at the same time. I have the privilege of being one of the co-founders of the MD2'HSE AI platform. This initiative represents an implementation of cutting-edge AI technology within our department, aimed at enhancing our operations and performance and lowering the casualties and energy consumption within the company’s power plant. You can read more about it [here](https://www.mapnamd2.com/en/). Every day, here, I get to create awesome experiences and engage with the vibrant GitHub developer community and I love it. So with that being said Feel free to get in touch 😊
